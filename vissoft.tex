...
When it comes to implementing the backend, Python is currently one of the most popular programming languages\footnote{Searching for projects written in Python on GitHub returns more than 500K open source projects as results}. At the time of writing this paper Python is the 4th most popular programming language in the Tiobe Index\footnote{TIOBE programming community index is a measure of popularity of programming languages, created and maintained by the TIOBE Company based in Eindhoven, the Netherlands}. 
