...
\label{sec:user}
  ...
  The limitation of the previous view is that it does not present the information also on a per version basis. To address this, a different visual perspective entitled \view{Performance per User per Version}
  Figure \ref{fig:tuv} attempts to present the information 
