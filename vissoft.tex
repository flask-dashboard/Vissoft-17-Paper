...
\todo{Streamline the following paragraph and connect with above:}
...
\va{Mircea: I don't think it's proper to discuss about utilization here (and definitely not in the title) since we have 0 graphs that actually visualize utilization; furthermore, we still cannot demonstrate how lightweight it actually is so we have to be careful in how we use the term --- consider removing also from the title}
